    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(info.equals("new")){
            ...
            try{
                ...
                Cursor cursor = database.rawQuery("SELECT * FROM recipes WHERE id = ?",new String[]{String.valueOf(recipeId)});

                int recipeNameIx = cursor.getColumnIndex("recipename");
                int ingredientsTextIx = cursor.getColumnIndex("ingredient");
                int howTextIx = cursor.getColumnIndex("how");
                int imageIx= cursor.getColumnIndex("image");

                while (cursor.moveToNext()){
                    binding.RecipeText.setText(cursor.getString(recipeNameIx));
                    binding.ingredientsText.setText(cursor.getString(ingredientsTextIx));
                    binding.howText.setText(cursor.getString(howTextIx));
